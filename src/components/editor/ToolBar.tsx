  ...
  return (
    <div className="w-full flex flex-row justify-start gap-3 px-2 py-2 bg-secondary rounded-xl shadow-lg">
      ...
      >
        <Button
          ...
          onClick={() => {
            const newBlockId = focusedBlockId
              ? addNewBlockAfter(focusedBlockId, "text")
              : addNewBlock("text");
        ...
        <div
          className={`
            flex gap-1 absolute left-full top-0
            transition-all duration-300 bg-dark-transparent-5 rounded-2xl
            ${
              showHeadings
        ...
        >
          <Button
            className="click-effect"
            onClick={() =>
              focusedBlockId && changeBlockType(focusedBlockId, "h1")
            }
          >
          ...
          <Button
            className="click-effect"
            onClick={() =>
              focusedBlockId && changeBlockType(focusedBlockId, "h2")
            }
          >
          ...
          <Button
            className="click-effect"
            onClick={() =>
              focusedBlockId && changeBlockType(focusedBlockId, "h3")
            }
          >
          ...
          <Button
            className="click-effect"
            onClick={() =>
              focusedBlockId && changeBlockType(focusedBlockId, "text")
            }
          >
